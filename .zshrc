...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting zsh-completions web-search)
...
alias npm_factory="nvm use v18.14.1"
alias npm_frenetic="nvm use v16.20.0"
...
__conda_setup="$('/Users/dimanu/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/dimanu/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/dimanu/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/dimanu/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="$PATH:/Users/dimanu/.local/bin"
